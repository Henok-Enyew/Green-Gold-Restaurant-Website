function Footer() {
  return (
    <footer className="flex gap-x-16 w-full h-60 bg-bg-primary py-10 px-44 text-gray-300">
      ...
      <div>
        <p className="text-primary-bold text-md mb-3 ">Location</p>
        <p className="text-sm font-extralight">
          Diaspora - Abay Mado - Bahirdar{" "}
        </p>
      </div>
      <div>
        <p className="text-primary-bold text-md mb-3 ">Services</p>
        <p className="text-sm font-extralight">Traditional Foods</p>
        <p className="text-sm font-extralight">Fresh Juice</p>
        <p className="text-sm font-extralight">Hot Coffee</p>
      ...
      <div>
        ...
        <div className="flex mt-3 items-center justify-center gap-3">
          <a href="https://github.com/Henok-Enyew" target="_blank">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="fill-primary w-8 h-8 hover:fill-primary-l duration-200 hover:scale-90"
              viewBox="0 0 30 30"
            >
